<?php
/**
 * @version		$Id: controller.php 26/02/2012 9.35
 * @package		Joomla.Administrator
 * @subpackage	aa4j
 * @copyright	Copyright (C) 2005 - 2012 alikonweb.it All rights reserved.
...
function logchksum (){ 
  ...
  echo '<pre><ul>';
	$lines = @file(JPATH_SITE.DS.'cli'.DS.'checksum'.DS.'logs'.DS.'jchecksum.php');
	foreach($lines as $line)
  {
	 if (strpos($line,'ERROR')){
      echo'<ol style="color:#FF0000">'.$line.'</ol>';
   }else {
   	  echo '<ol style="color:#000000">'.$line.'</ol>';
   }	
  }
  echo '</ul></pre>';

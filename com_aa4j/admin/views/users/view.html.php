...
class Aa4jViewUsers extends JView
{
	...
	// Include the component HTML helpers.
		...
		JSubMenuHelper::addEntry(
			...
			'ausers'
                ...
                JSubMenuHelper::addEntry(
			JText::_('COM_AA4J_VIEW_LOC_TITLE'),
			'index.php?option=com_aa4j&view=component&component=loc',
			'ausers'
		);
		parent::display($tpl);
	}
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_AA4J_VIEW_USERS_TITLE'), 'doctor');
/*
...
*/
		if ($canDo->get('core.edit.state')) {
			...
			JToolBarHelper::custom('users.detect', 'detect', 'detect','COM_AA4J_TOOLBAR_DETECT', 'index.php?option=com_aa4j&task=detect', true);
			...
			JToolBarHelper::custom('users.block', 'spam','spam','COM_AA4J_TOOLBAR_BLOCK', true);
			JToolBarHelper::custom('users.unblock', 'unspam', 'unspam', 'COM_AA4J_TOOLBAR_UNBLOCK', true);
			JToolBarHelper::divider();
		}

		if ($canDo->get('core.delete')) {
			JToolBarHelper::deleteList('', 'users.delete','delete');
			JToolBarHelper::divider();
		}
